...
class Results2Page extends StatelessWidget {
  ...
  final String alternativeValue1;
  final String alternativeValue2;
  ...
  const Results2Page({
    ...
    this.alternativeValue1 = 'Value 1',
    this.alternativeValue2 = 'Value 2',
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: const [
            Text('vubayu results', style: TextStyle(color: Color(0xFF00ffbc), fontSize: 20, fontFamily: 'Quicksand')),
          ],
        ),
      ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 16),
              _buildSection('Seeds for Cash Crops', seedsCashCropsValue1, seedsCashCropsValue2, Icons.grass, Icons.eco),
              _buildSection('Endangered Species', endangeredSpeciesValue1, endangeredSpeciesValue2, Icons.pets, Icons.bug_report),
              _buildSection('Sustainable Farming Tools', farmingToolsValue1, farmingToolsValue2, Icons.agriculture, Icons.build),
              _buildExpandableCard('Fertilizers & Alternative Uses', 'Pesticides: $alternativeValue1', 'Usefulness: $alternativeValue2'),
              _buildExpandableCard('Thermal & Ecological Footprint', 'Heat Capacity: $bestCaptureValue1', 'Eco Impact: $bestCaptureValue2'),
              _buildExpandableCard('Construction Suitability', 'Suitable: $cultivationSystemValue1', 'Types: $cultivationSystemValue2'),
              _buildExpandableCard('Natural Disaster Risks', 'Risk 1: $naturalDisasterValue1', 'Risk 2: $naturalDisasterValue2'),
            ],
          ),
        ),
      ),
  ...
  Widget _buildSection(String title, String value1, String value2, IconData icon1, IconData icon2) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(title, style: TextStyle(color: Color(0xFF00ffbc), fontSize: 16, fontFamily: 'Quicksand')),
        SizedBox(height: 8),
        Row(
          children: [
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          SizedBox(height: 8),
          Text(value, style: TextStyle(color: Color(0xFF00ffbc), fontFamily: 'Quicksand')),
        ],
      ),
    );
  }

  Widget _buildExpandableCard(String title, String alternativeValue1, [String? value2]) {
  return Theme(
    data: ThemeData(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  ' $alternativeValue1',
                  style: TextStyle(color: Color(0xFF00ffbc), fontFamily: 'Quicksand', fontSize: 15),
                ),
                if (value2 != null)
                  Text(
                    ' $value2',
